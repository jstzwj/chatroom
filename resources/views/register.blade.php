...
<div class="container">
        ...
        <?php echo csrf_field(); ?>
            ...
            <p class="a">
                <input type="password" class="input-block-level form-control" data-container="body" data-toggle="password_popover" data-placement="right" data-content="请再次输入密码" onclick="cancelWarning();" placeholder="password" name="user_confirm_pw">
            </p>
